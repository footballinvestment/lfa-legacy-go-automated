...
def get_error_metrics(hours: int = 24) -> Dict[str, Any]:
    ...
    try:
        ...
        logger.info(f"Error metrics requested for {hours} hours", extra={
...
def clear_old_metrics(hours: int = 48) -> Dict[str, Any]:
    ...
    try:
        ...
        logger.info(f"Metrics cleared for data older than {hours} hours", extra={
            "cleared_hours": hours
        })
    ...
    try:
        ...
        if error_summary["total_errors"] > 10:
            alerts.append({
                ...
                "severity": "critical" if error_summary["total_errors"] > 50 else "warning",
