...
class Location(Base):
    ...
    location_type = Column(
        Enum(LocationType), nullable=False, default=LocationType.OUTDOOR
    )
    ...
    tournaments = relationship(
        "Tournament",
        foreign_keys="Tournament.location_id",
...
class GameSession(Base):
    ...
    # Game Information
    game_definition_id = Column(
        Integer, ForeignKey("game_definitions.id"), nullable=False
    )
