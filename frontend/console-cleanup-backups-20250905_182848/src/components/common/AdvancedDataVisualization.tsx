...
const AdvancedDataVisualization: React.FC = () => {
  ...
  const LineChartWrapper: React.FC<VisualizationProps> = ({
    data,
    config,
    height = 300,
  }) => (
  ...
  const AreaChartWrapper: React.FC<VisualizationProps> = ({
    data,
    height = 300,
  }) => (
    <ResponsiveContainer width="100%" height={height}>
  ...
  const BarChartWrapper: React.FC<VisualizationProps> = ({
    data,
    height = 300,
  }) => (
    <ResponsiveContainer width="100%" height={height}>
  ...
  const PieChartWrapper: React.FC<VisualizationProps> = ({
    data,
    height = 300,
  }) => (
    <ResponsiveContainer width="100%" height={height}>
  ...
  const RadarChartWrapper: React.FC<VisualizationProps> = ({
    data,
    height = 300,
  }) => (
    <ResponsiveContainer width="100%" height={height}>
  ...
  const ScatterChartWrapper: React.FC<VisualizationProps> = ({
    data,
    height = 300,
  }) => (
    <ResponsiveContainer width="100%" height={height}>
  ...
  const ComposedChartWrapper: React.FC<VisualizationProps> = ({
    data,
    height = 300,
  }) => (
    <ResponsiveContainer width="100%" height={height}>
    ...
    const charts = [
      {
        ...
        component: (
          <LineChartWrapper data={performanceData} config={{} as ChartConfig} />
        ),
        icon: <ShowChart />,
      ...
      },
      {
        ...
        component: (
          <AreaChartWrapper data={performanceData} config={{} as ChartConfig} />
        ),
        icon: <Timeline />,
      ...
      },
      {
        ...
        component: (
          <BarChartWrapper data={performanceData} config={{} as ChartConfig} />
        ),
        icon: <BarChartIcon />,
      ...
      },
      {
        ...
        component: (
          <RadarChartWrapper data={skillRadarData} config={{} as ChartConfig} />
        ),
        icon: <TrendingUp />,
      ...
      },
      {
        ...
        component: (
          <ScatterChartWrapper data={scatterData} config={{} as ChartConfig} />
        ),
        icon: <FilterList />,
          ...
          <Grid item xs={12} md={6} key={index}>
            ...
            >
              <CardContent>
                ...
                >
                  <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                    <Avatar
                      sx={{
                        bgcolor:
                          getCurrentColors()[index % getCurrentColors().length],
                      }}
                    >
                      {chart.icon}
                    </Avatar>
                ...
                <Box sx={{ height: 300 }}>{chart.component}</Box>
  ...
  return (
    <Box sx={{ p: 3 }}>
      ...
      <Typography variant="body1" color="text.secondary" sx={{ mb: 3 }}>
        Comprehensive collection of reusable, interactive chart components with
        advanced features including real-time updates, dark mode support,
        animation controls, and export capabilities.
      </Typography>
          ...
          <Card>
            <CardContent>
              ...
              <Typography variant="body1" paragraph>
                The Advanced Data Visualization Library provides a comprehensive
                set of reusable chart components built on top of Recharts with
