...
const useMobileViewport = () => {
  ...
  function getSafeAreaInsets() {
    ...
    return {
      top:
        getInsetValue("--safe-area-inset-top") ||
        getInsetValue("env(safe-area-inset-top)") ||
        (isStandaloneMode() && getPlatform() === "iOS" ? 20 : 0),
      bottom:
        getInsetValue("--safe-area-inset-bottom") ||
        getInsetValue("env(safe-area-inset-bottom)") ||
        0,
      left:
        getInsetValue("--safe-area-inset-left") ||
        getInsetValue("env(safe-area-inset-left)") ||
        0,
      right:
        getInsetValue("--safe-area-inset-right") ||
        getInsetValue("env(safe-area-inset-right)") ||
        0,
    };
  }
