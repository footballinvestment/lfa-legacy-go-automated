...
const gameResultsService = {
  async getStatistics(timeframe = 'all') {
    ...
    return {
      ...
      achievements: [
        { id: 1, name: 'First Victory', description: 'Win your first game', earned_at: '2025-01-10' },
        { id: 2, name: 'Hat Trick Hero', description: 'Score 3 goals in a single game', earned_at: '2025-01-12' },
        { id: 3, name: 'Winning Streak', description: 'Win 3 games in a row', earned_at: '2025-01-15' },
      ],
    };
  },
};
...
const Statistics: React.FC = () => {
  ...
  const getPerformanceTrendIcon = (trend: string) => {
    switch (trend) {
      ...
      default: return <Analytics color="primary" />;
    }
  };
        ...
        <Grid size={{ xs: 12, md: 8 }}>
            ...
            <CardContent>
              ...
              <Box sx={{ mt: 3 }}>
                ...
                <LinearProgress
                  ...
                  color={statistics.overall.win_rate >= 60 ? 'success' : statistics.overall.win_rate >= 40 ? 'warning' : 'error'}
          ...
          <Card>
            <CardContent>
              ...
              <Grid container spacing={2}>
                {Object.entries(statistics.by_game_type).map(([gameType, stats]) => (
                    ...
                    <Card variant="outlined">
                      <CardContent sx={{ textAlign: 'center' }}>
                        ...
                        <Chip
                          ...
                          color={stats.win_rate >= 60 ? 'success' : stats.win_rate >= 40 ? 'warning' : 'error'}
                          size="small"
                          sx={{ mt: 1 }}
                        />
                      </CardContent>
          ...
          <Card sx={{ mb: 3 }}>
            <CardContent>
              ...
              <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 2 }}>
                {statistics.recent_performance.last_5_games.map((result, index) => (
              ...
              <Chip
                ...
                color={getPerformanceTrendColor(statistics.recent_performance.trend)}
                icon={getPerformanceTrendIcon(statistics.recent_performance.trend)}
                sx={{ width: '100%' }}
              />
            </CardContent>
          </Card>
          ...
          <Card sx={{ mb: 3 }}>
            <CardContent>
              ...
              <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 2 }}>
                ...
                <Typography variant="body2" fontWeight="bold" color={statistics.overall.goal_difference >= 0 ? 'success.main' : 'error.main'}>
                  {statistics.overall.goal_difference >= 0 ? '+' : ''}{statistics.overall.goal_difference}
                </Typography>
              </Box>
