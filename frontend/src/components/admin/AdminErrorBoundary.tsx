      ...
      <Paper elevation={3} sx={{ maxWidth: 700, p: 4 }}>
        <Stack spacing={3} alignItems="center">
          ...
          <Alert severity="error" sx={{ width: "100%" }}>
            ...
            The admin interface encountered an unexpected error. This could be
            due to:
          ...
          <Typography variant="body1" color="text.secondary" align="center">
            Your admin session is still active. You can try to recover by
            refreshing the component or navigating to a different admin section.
          </Typography>
